"""Tests for the all-minilm-l6-v2 model script (fully mocked; no weights loaded)."""
...
def test_manifest_has_required_fields():
    from muse.models.all_minilm_l6_v2 import MANIFEST
    assert MANIFEST["model_id"] == "all-minilm-l6-v2"
...
def test_minilm_model_id_and_dimensions():
    with patch("muse.models.all_minilm_l6_v2.SentenceTransformer") as mock_cls:
...
def test_minilm_module_imports_without_sentence_transformers_installed():
    ...
    import muse.models.all_minilm_l6_v2 as mod
