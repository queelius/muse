"""Tests for the qwen3-embedding-0.6b model script (fully mocked; no weights loaded)."""
...
def test_manifest_has_required_fields():
    from muse.models.qwen3_embedding_0_6b import MANIFEST
    assert MANIFEST["model_id"] == "qwen3-embedding-0.6b"
...
def test_qwen3_model_id_and_dimensions():
    with patch("muse.models.qwen3_embedding_0_6b.SentenceTransformer") as mock_cls:
